...
const BookaVisit = () => {
  ...
  return (
    <>
    <Helmet>
      <title>Harigurus | Book & Visit</title>
    </Helmet>
      ...
      <div className="detailllssecondmaincontianer">
        ...
        <div className="detailstlssecondcontainer">
          ...
          <div className="detailstlsprofileimagecontainer">
            <img className='detialsimage' src={astrologysecondImage} alt="" />
          </div>
          {/* aksharabhyasa details container */}
          <div className="detailsdetailsdetailssecondcontainer">
           <h1 className='detaildetailsheading'>Book & Visit</h1>
           <p className='detaildetailsparagraph'>Browse through our list of qualified astrologers along with their expertise and location to find those who meet your requirements. Once you have found what you are looking for, book an appointment and visit them.</p>
          ...
          <div className="contentboxconditionrendering">
            ...
            {/* <p className="togglecontentparagraph"> */}
              {howdoweHelp?(
                ...
                <>
                <p className='togglecontentparagraph'>Browse through our list of qualified astrologers along with their expertise and location to find those who meet your requirements. Once you have found what you are looking for, book an appointment and visit them.</p>
                </>
              )}
            {/* </p> */}
          </div>
